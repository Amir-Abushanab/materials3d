...
Scene-level refractive glass for the web, on three.js: a small four-pass renderer in which colour
comes from soft lamps behind the glass and the glass bends it. Built for hero sections and product
visuals. Ships as a React component, a custom element and a plain TypeScript core, plus Materials
Studio, a browser tool for designing scenes and exporting them.
...
still, a clip, code, config, a share link or an embed page. It runs at
https://materials-studio.pages.dev and locally with `pnpm dev`.
