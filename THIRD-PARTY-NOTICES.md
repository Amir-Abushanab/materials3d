...
site. `@materials3d/core` carries the notices and license texts for the code it
ships in its own tarball; `@materials3d/react` and `@materials3d/element` bundle no
third-party code.
