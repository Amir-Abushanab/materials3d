...
// The icon + glow tint come from --g3-bf-col (green by default, red for the error variant), so the
// success and error flashes share one keyframe.
const CSS = `
.g3-bf-ic{display:inline-flex;align-items:center;vertical-align:-2px;margin-right:6px;
  color:rgb(var(--g3-bf-col,38,150,104))}
.g3-bf-flash{--g3-bf-col:38,150,104}
.g3-bf-flash.g3-bf-err{--g3-bf-col:196,58,58}
@media (prefers-reduced-motion: no-preference){
  .g3-bf-flash .tp-btnv_b, button.g3-bf-flash{
    animation: g3-bf-pop 260ms cubic-bezier(0.16,1,0.3,1), g3-bf-glow 900ms ease-out;
  }
  .g3-bf-ic{animation: g3-bf-icon 300ms cubic-bezier(0.16,1,0.3,1) both}
  @keyframes g3-bf-pop{40%{transform:scale(1.03)}}
  @keyframes g3-bf-glow{
    0%{box-shadow:0 0 0 0 rgba(var(--g3-bf-col,38,150,104),0)}
    16%{box-shadow:0 0 0 1.5px rgba(var(--g3-bf-col,38,150,104),0.6), 0 0 12px rgba(var(--g3-bf-col,38,150,104),0.3)}
    100%{box-shadow:0 0 0 0 rgba(var(--g3-bf-col,38,150,104),0)}
  }
  @keyframes g3-bf-icon{from{transform:scale(0.3);opacity:0}to{transform:scale(1);opacity:1}}
}
`;
...
function flash(el: HTMLElement, label: string, duration: number, error: boolean): void {
  ...
  void el.offsetWidth;
  el.classList.add("g3-bf-flash");
  if (error) el.classList.add("g3-bf-err");
  timers.set(
    target,
    window.setTimeout(() => {
