...
export default defineConfig({
  entry: [
    ...
    // The WebGPU engine's own subpath, `@materials3d/core/renderer-webgpu`. Also reachable through
    // the dynamic import in core-loader-webgpu, but an entry gives it a stable d.ts of its own.
    "src/renderer/NodeMaterialRenderer.ts",
  ],
  format: "esm",
  dts: true,
  sourcemap: true,
