...
| prop                                                                                          | notes                                                                                                                                                                                                                              |
| --------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `preset`                                                                                      | a name (`"skewer"`, `"assembly"`, `"staircase"`, `"slimes"`, `"reactions"`, `"materials"`, `"prism"`, `"knot"`, `"aperture"`) or a function returning a config. A name lazy-loads the presets chunk; a function is tree-shakeable. |
