...
function Materials3DInner(
  ...
  useImperativeHandle(
    ...
    () => ({
      ...
      enableTilt: () => handleRef.current?.enableTilt() ?? Promise.resolve(false),
      tiltStatus: () => handleRef.current?.tiltStatus() ?? "prompt",
      recenterTilt: () => handleRef.current?.recenterTilt(),
