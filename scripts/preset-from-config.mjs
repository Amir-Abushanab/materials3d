 ...
 *
 *   pnpm preset:from ~/Downloads/scene.json
...
async function main() {
  ...
  const baseName = argv.includes("--base") ? argv[argv.indexOf("--base") + 1] : undefined;
  if (!file) throw new Error("usage: pnpm preset:from <config.json> [--base <preset>]");
